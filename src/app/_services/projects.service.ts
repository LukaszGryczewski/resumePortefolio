...
export class ProjectsService {
  ...
  projects : Project[] = [
    ...
    {id:3, name:'Spring Project ', summary:'Under construction', description:'Under construction', projectLink:'', tags:[Tag.SPRING,Tag.ANGULAR,Tag.TYPESCRIPT,Tag.HTML,Tag.CSS], pictures:["../../assets/pictures/default-image.jpg"]},
