...
export class ProjectsService {
  ...
  projects : Project[] = [
    ...
    {id:5, name:'Laravel Project Reservation ', summary:'Website for reservation, buy teather, movie Theater ticket', description:'Website for reservation, buy teather, movie Theater ticket', projectLink:'', tags:[Tag.LARAVEL,Tag.BOOTSTRAP,Tag.PHP,Tag.JAVASCRIPT,Tag.JQUERY,Tag.HTML,Tag.CSS], pictures:["../../assets/pictures/default-image.jpg"]},
